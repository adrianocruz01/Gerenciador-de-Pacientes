...
export class PatientTransferService {
  ...
  async execute(transferenciaPacienteData: CreateTransferenciaPacienteDto, colaborador_id: number) {
    const { paciente_id, procedimento_id, paciente_procedimento_id } = transferenciaPacienteData;
    ...
    if (exists) {
      throw new BadRequestException(
        'Esta ficha de transferência de paciente já existe para este paciente e procedimento',
      );
    }
    ...
    const create = await this.prisma.ficha_Transferencia_Paciente.create({
      data: {
        ...
        capaz_respirar_profundamente_indicealdrete:
          transferenciaPacienteData.capaz_respirar_profundamente_indicealdrete,
        ...
        dispineia_movimento_respiratorio_indicealdrete:
          transferenciaPacienteData.dispineia_movimento_respiratorio_indicealdrete,
        ...
        dispineia_movimento_respiratorio_antesalta:
          transferenciaPacienteData.dispineia_movimento_respiratorio_antesalta,
        ...
        movimentar_qualquer_extremidades_indicealdrete:
          transferenciaPacienteData.movimentar_qualquer_extremidades_indicealdrete,
        ...
        movimentar_qualquer_extremidades_antesalta:
          transferenciaPacienteData.movimentar_qualquer_extremidades_antesalta,
    ...
    await this.prisma.log.create({
      data: {
        ...
        atributo: 'Ficha de transferência de paciente',
